          ...
          <form action="/form-validate.php" method="post">
            ...
            <div class="mb-3">
              ...
              <input
                ...
                placeholder="foo bar baz"
              />
              <div class="form-text">Text d'aide pour remplir le champ</div>
            ...
            <div class="mb-3">
              <p>Choisissez votre fruit préféré :</p>
              <input
                class="form-control"
                type="text"
                name="login"
            ...
            <div class="mb-3">
                <p>Votre film préférés :</p>
                <!-- l'atribute "size" permet de choisir le nombre d'éléments affichés en même temps -->
                <!-- <select name="film" id="film" size="3"> -->
                <select name="film" id="film">
                    <option value="interstellar">Interstellar</option>
                    <option value="fight club">Fight club</option>
                    <!-- l'atributet "selected" permet d'indiquer quel élément est selectionné par defaut  -->
                    <option value="shining" selected>Shining</option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="singers[]" id="singers" size="5" multiple>
                    <option id="singers_1" value="celine lion">Céline Lion</option>
                    <option id="singers_2" value="linkin park">Linkin Park</option>
                    <option id="singers_3" value="jean-jaqcues goldman">Jean-Jacques Goldman</option>
                </select>
            </div>
